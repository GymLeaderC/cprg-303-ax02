...
## /app - Lives within the Root Folder. Contains all Routing Files
- `_layout.tsx`
### (tabs) - Lives within the /app Folder. For organizational purposes only, not required for routing
- `_layout.tsx`
- `create.tsx`
- `index.tsx`
- `library.tsx`
...
## /components - Lives within the Root Folder. Contains all Component Files
...
## /data - Lives within the Root Folder. Contains all Data Files
